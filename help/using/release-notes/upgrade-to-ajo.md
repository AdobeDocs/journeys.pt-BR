...
# Atualizar seu ambiente do Journey Orchestration para o Adobe Journey Optimizer{#ugrade-ajo}
...
O Journey Orchestration é um serviço criado na Adobe Experience Platform que permite adaptar jornadas individuais para cada cliente com base em seu comportamento e preferências anteriores. O Journey Orchestration é o aplicativo precursor do Journey Optimizer.
...
<tr>
<td><img src="../assets/migration-ajo-1.png"><p>Seção Acesso a Jornadas, segmentos e administração (fontes de dados, eventos e ações) no Journey Orchestration. Segmentos e conjuntos de dados podem ser acessados na Adobe Experience Platform. </p></td>
...
## Como atualizar meu ambiente do Journey Orchestration?
...
### Preciso planejar algo para migrar do Journey Orchestration para o Adobe Journey Optimizer?

Não, não há migração, não há necessidade de trabalho, não há tempo de inatividade e nenhum investimento adicional. Você só precisa atualizar seu contrato com a Adobe e fazemos o resto. Entre em contato com o representante de conta para obter instruções sobre como iniciar esse processo.
...
### Ainda vejo o Journey Orchestration no alternador de aplicativos. Isso é normal?

![](../assets/migration-ajo-9.png)

Sim, é normal. Você ainda poderá ver o item do Journey Orchestration por alguns dias após a atualização. Use o Journey Optimizer.
