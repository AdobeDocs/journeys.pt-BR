...
Aqui estão as possibilidades [!DNL Journey Orchestration] ofereça a você segmentos:
...
* Adicione um **[!UICONTROL Segment qualification]** à sua jornada para ouvir as entradas e saídas dos perfis nos segmentos do Adobe Experience Platform. Consulte [Atividades de eventos](../building-journeys/segment-qualification-events.md).
