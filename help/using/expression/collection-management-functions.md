...
A função **[!UICONTROL all]** habilita a definição de um filtro em uma determinada coleção usando uma expressão booleana.
...
>
>* A função **[!UICONTROL first]** retornará o evento mais recente
